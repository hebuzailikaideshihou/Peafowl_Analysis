...
blastp -query Pven.pep.fasta -db ./uniprot_20180118/uniprot_sprot.20180118.fasta -num_threads 28 -evalue 1e-3 -outfmt 6 -max_target_seqs 1 -out Pven.fasta.blastpout6 &>blastp_run.log

perl ./releated_scripts/add_swissprot_annotation.pl ./uniprot_20180118/uniprot_sprot.20180118.fasta White_Pavo.pep.fasta Pven.fasta.blastpout6  >Pven.pep.anno.fasta